...
const area = {
  ...
  //   // TODO: use the moveTo() function to move tthe ball
      
      moveTo(ball, x, y);
    // TODO: use the Javascript setTimeout() method to call changeDirectionIfNecessary() and update() every 16ms
    setTimeout(function () {
      ball.changeDirectionIfNecessary(ball,x, y);
      ball.update(ball,x + ball.dx, y + ball.dy);
  }, 16); 
  }
  // setTimeout(changeDirectionIfNecessary,16);
  // setTimeout(update,16);
  // setTimeout(newBall.changeDirectionIfNecessary(ball, x, y),16);
  // setTimeout(newBall.update(ball, x + ball.dx, y + ball.dy),16);
